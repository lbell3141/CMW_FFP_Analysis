...
SRGtowerdat <- read.csv("./Data/RussHomework/GapfilledPartitionedFluxes_US-SRG_HH_ALL/GapfilledPartitionedFluxes_US-SRG_HH_202312312330_202412312330.csv", na.strings = "-9999")%>%
...
timemerge <- merge(SRGtowerdat, SRGffpdat, by = c("yyyy", "mm", "day", "HH", "MM"))
...
saveRDS(ffp_list, file = "./Data/RussHomework/SRG_2024_ffps/sep_calcd_ffp_list.rds")
#to read use readRDS()
