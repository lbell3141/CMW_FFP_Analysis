...
#==============================
chm <- rast("./Data/RussHomework/SRM_RS/CHM.tif")
chm <- terra::ifel(chm > 0.3, chm, NA)

cover <- rast("./Data/RussHomework/SRM_RS/Cover.tif")
cover <- terra::ifel(cover > 0, cover, NA)
plot(cover)
#==============================
# FFP files per month
#==============================
ffp_files <- list(
  May   = "./Data/RussHomework/SRM_2024_ffps/may_calcd_ffp_list.rds",
  Jun   = "./Data/RussHomework/SRM_2024_ffps/jun_calcd_ffp_list.rds",
  Jul   = "./Data/RussHomework/SRM_2024_ffps/jul_calcd_ffp_list.rds",
  Aug   = "./Data/RussHomework/SRM_2024_ffps/aug_calcd_ffp_list.rds",
  Sep   = "./Data/RussHomework/SRM_2024_ffps/sep_calcd_ffp_list.rds"
)
