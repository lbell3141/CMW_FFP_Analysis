...
PathToOutput <- "./Plots/footprints/CMW_WD_by_10deg/with_NDVI"
...
#===============================================================================
#===========================save ffp plots with NDVI=============================
#===============================================================================
#on top of RAP data
#code adapted from Contours_to_Mask.R function, ffp_contours_to_mask
rast_file <- rast("./Data/Planet/AUG2018/reprodNDVIrast.tif")
out
ffp_list <- readRDS("./Data/calcd_ffp_list.rds")
x_list <- list()
y_list <- list()
...
lines_list <- list()
for (i in seq_along(x_list)) {
  lines_list[[i]] <- ffp_contours_to_mask(x_list[[i]], y_list[[i]], rast_file)
}
...
plot_lines_over_raster(lines_list, rast, PathToOutput)
