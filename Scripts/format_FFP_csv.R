#Format flux data csv for Kljun et al. (2015) FFP online calculator
#csv code outputs sometimes need to be pasted into provided template files to work with the online calculator
#This script generates 3 csvs. 
  #The first is a daytime footprint for all directions
  #The second is a daytime footprint for the Northwest
  #The third is a daytime footprint for the Southeast
...
write.csv(dat_ffp, pathtoFullDaytimeOutput, row.names = FALSE)
