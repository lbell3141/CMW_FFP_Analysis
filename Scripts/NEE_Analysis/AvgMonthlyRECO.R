...
create_monthly_reco_plot <- function(month_abbr, month_full) {
  variable_col <- paste0(month_abbr, "_reco")  # column like "Jan_reco", "Feb_reco", etc.
...
plots <- Map(create_monthly_reco_plot, month_abbr, month_full)
...
# ---- Display
final_plot + plot_annotation(title = "Average Directional Respiration (µmolCO2 m-2 s-1)")
